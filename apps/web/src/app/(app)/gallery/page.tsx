...
import { EXAMPLE_CONNECTORS, type ExampleConnector } from '@mcpforge/domain'
...
export default function GalleryPage() {
  ...
  const examples = EXAMPLE_CONNECTORS.filter(
    (e) =>
      !filter ||
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-5">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-neutral-500">{EXAMPLE_CONNECTORS.length} templates</span>
      </div>
