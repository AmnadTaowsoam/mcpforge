# MCPForge Backend Implementation Specification
...
- Database: PostgreSQL for template registry, file output for generated projects.
- Queue: Template generation jobs for long-running scaffold creation.
...
1. Create project for MCP server generation.
...
- Worker can complete the primary MCP server generation workflow using sample inputs.
